...
echo set CONDA_ROOT_PREFIX=%%~dp0alltalk_environment\conda >> start_environment.bat
echo set INSTALL_ENV_DIR=%%~dp0alltalk_environment\env >> start_environment.bat
echo call "%%CONDA_ROOT_PREFIX%%\condabin\conda.bat" activate "%%INSTALL_ENV_DIR%%" >> start_environment.bat
echo cmd /k >> start_environment.bat

@rem Create start_alltalk.bat to run AllTalk
echo @echo off > start_alltalk.bat
echo cd /D "%%~dp0" >> start_alltalk.bat
echo set CONDA_ROOT_PREFIX=%%~dp0alltalk_environment\conda >> start_alltalk.bat
echo set INSTALL_ENV_DIR=%%~dp0alltalk_environment\env >> start_alltalk.bat
...
echo set CONDA_ROOT_PREFIX=%%~dp0alltalk_environment\conda >> start_finetune.bat
echo set INSTALL_ENV_DIR=%%~dp0alltalk_environment\env >> start_finetune.bat
...
@rem Create start_diagnostics.bat to run AllTalk
echo @echo off > start_diagnostics.bat
echo cd /D "%%~dp0" >> start_diagnostics.bat
echo set CONDA_ROOT_PREFIX=%%~dp0alltalk_environment\conda >> start_diagnostics.bat
echo set INSTALL_ENV_DIR=%%~dp0alltalk_environment\env >> start_diagnostics.bat
